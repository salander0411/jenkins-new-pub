...
# 基于k8s on AWS实现基于jenkins pipeline的CI/CD
...
3. 配置jenkins于kubernetes集成
   ...
   配置完毕后，点击**右下方**的**test connection**，如果出现 Connection test successful 的提示信息证明 Jenkins 已经可以和 Kubernetes 系统正常通信了；如果测试不成功，请仔细检查参数是否正确
